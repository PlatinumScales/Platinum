...
public class EventManagement {
	...
	public boolean createVortexEvent(String nombre, String descripcion, Date fecha, int horaInicio,
	...
	public boolean customerReservation(int idCliente, String nombre, String descripcion,
			int publico, Date fecha, int horaInicio, int horaFin, int cupo, String imagenUrl) {
	...
	// Returns the first table available for a reservation, null if there is
	// none
	...
	// Manager use: Confirms a customer attended the event reservation not
	// necessary
	...
	// Returns coming Vortex events (from Today)
	public List<Evento> getVortexEvents() {

		EventoService es = new EventoService();
		es.startEntityManager(persistanceUnit);
		return es.findVortexEvents();
	}

	// Returns coming Customer reservations (from Today)
	public List<Evento> getCustomerReservations() {
		EventoService es = new EventoService();
		es.startEntityManager(persistanceUnit);
		return es.findCustomerEvents();
	}
